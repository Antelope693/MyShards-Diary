...
本项目支持多种部署方式，适合不同技术背景的用户。

### 方式一：宝塔面板部署 (推荐)
适合拥有云服务器（CentOS/Ubuntu）的用户，详情请见：
👉 **[DEPLOYMENT_BAOTA.md (宝塔部署指南)](./DEPLOYMENT_BAOTA.md)**

### 方式二：Docker 一键部署
适合熟悉容器化的用户。
1. 下载项目。
2. 复制 `.env.example` 为 `.env` 并配置参数。
...
---
*Created with ❤️ by 羚羊 & Antigravity Agent*
